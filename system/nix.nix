      ...
      files."nix.conf" = {
        ...
        template = let
            ...
            mkValueString = v:
              ...
              else if (lib.isInt v || lib.isList v || lib.isDerivation v || builtins.isPath v || lib.strings.isConvertibleWithToString v) then toString v
