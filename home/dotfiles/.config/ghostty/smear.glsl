...
// Catppuccin Mocha Maroon (#eba0ac) trail fading to Earthsong background (#292520)
const vec4 TRAIL_COLOR = vec4(pow(vec3(0.92157, 0.62745, 0.67451), vec3(2.2)), 1.0);
const vec4 TRAIL_COLOR_FADE = vec4(pow(vec3(0.16078, 0.14510, 0.12549), vec3(2.2)), 0.0);

const float DURATION = 1.68; //IN SECONDS
