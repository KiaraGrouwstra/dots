...
map('n', 'K', '<C-b>', { desc = 'scroll up' })
map('v', 'K', '<C-b>', { desc = 'scroll up' })
map('n', 'J', '<C-f>', { desc = 'scroll down' })
map('v', 'J', '<C-f>', { desc = 'scroll down' })

map('n', '<ScrollWheelUp>', '<C-B>', { desc = 'scroll up' })
map('v', '<ScrollWheelUp>', '<C-B>', { desc = 'scroll up' })
map('n', '<ScrollWheelDown>', '<C-F>', { desc = 'scroll up' })
map('v', '<ScrollWheelDown>', '<C-F>', { desc = 'scroll up' })

map('n', 'gh', '0', { desc = 'start of line' })
map('v', 'gh', '0', { desc = 'start of line' })
map('n', 'gl', '$', { desc = 'end of line' })
map('v', 'gl', '$', { desc = 'end of line' })

map('n', 'ge', 'G', { desc = 'end of file' })
map('v', 'ge', 'G', { desc = 'end of file' })
map('n', '%', 'ggVG', { desc = 'select all' })
map('v', '%', 'ggVG', { desc = 'select all' })
