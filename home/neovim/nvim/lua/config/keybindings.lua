...
map('', 'K', '<C-b>', { desc = 'scroll up' })
map('', 'J', '<C-f>', { desc = 'scroll down' })

map('', '<ScrollWheelUp>', '<C-B>', { desc = 'scroll up' })
map('', '<ScrollWheelDown>', '<C-F>', { desc = 'scroll up' })

-- map('', 'gh', '0', { desc = 'start of line' })
-- map('', 'gl', '$', { desc = 'end of line' })
--
-- map('', 'ge', 'G', { desc = 'end of file' })
-- map('', '%', 'ggVG', { desc = 'select all' })

map('n', '<Leader>n', ':enew<CR>', { desc = 'new file' })
-- map('n', '<Leader>w', ':w<CR>', { desc = 'save file' })
map('n', '<Leader>x', ':bw<CR>', { desc = 'close file' })
...
map('', 'g;', '<Cmd>lua MiniJump2d.start(MiniJump2d.builtin_opts.single_character)<CR>', { desc = '2d jump char' })
map('', "g'", '<Cmd>lua MiniJump2d.start(MiniJump2d.builtin_opts.line_start)<CR>', { desc = '2d jump line' })
